...
const FieldJobList = () => {
    ...
    return (
        <div className={`min-h-screen pb-24 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
            ...
            <div className={`sticky top-0 z-30 px-6 pt-6 pb-4 transition-all duration-300 backdrop-blur-xl border-b 
                ...
                <div className={`p-1 rounded-2xl flex relative overflow-hidden ${darkMode ? 'bg-gray-800' : 'bg-gray-200/50'}`}>
                    {['all', 'pending', 'in-progress', 'done'].map((tab) => (
                        <button
                            ...
                            className={`flex-1 relative py-2 text-xs font-bold uppercase tracking-wide z-10 transition-colors duration-300
                                ${filter === tab
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-5 pl-7">
                                        <div className="flex justify-between items-start mb-3">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    ...
                                                    <span className={`flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider ${status.color}`}>
                                        ...
                                        <div className="grid grid-cols-2 gap-y-3 pt-2 border-t border-dashed border-gray-200 dark:border-gray-700">
